...
/* ══════════════════════════════════════
   ...
   No Three.js. No overhead. Just images.
══════════════════════════════════════ */
...
function pgOpen(el) {
  ...
  const alt    = el.dataset.alt || img.alt || '';
  const lb     = document.getElementById('pg-lightbox');
  const lbImg  = document.getElementById('pg-lightbox-img');
  const lbMeta = document.getElementById('pg-lightbox-meta');
  lbImg.src = img.src;
  lbImg.alt = alt;
