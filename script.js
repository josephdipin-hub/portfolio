...
/* ── Zone / image data — 3 zones ── */
const PRODUCT_ZONES = {
  ecommerce: {
    label: 'E-COMMERCE // WHITE BG',
    sublabel: 'Studio packshots & clean catalogue imagery',
    bgModel: 'tray',   // seeding_germination_watering_tray as bg
    cameraPos:    new THREE.Vector3(0, 0.08, 0.55),
    cameraLookAt: new THREE.Vector3(0, 0.0, 0),
    focusDepth: 1.2,
    images: [
  ...
  lifestyle: {
    ...
    bgModel: 'enlarger',  // durst enlarger as bg centrepiece
    cameraPos:    new THREE.Vector3(0, 0.05, 0.6),
    cameraLookAt: new THREE.Vector3(0, 0.0, 0),
    focusDepth: 1.4,
    images: [
  ...
  creative: {
    ...
    bgModel: 'stopwatch',  // stopwatch as bg
    cameraPos:    new THREE.Vector3(0, 0.04, 0.5),
    cameraLookAt: new THREE.Vector3(0, 0.0, 0),
    focusDepth: 1.0,
    images: [
...
const WaterShader = {
  uniforms: {
    tNormal:    { value: null },
    uTime:      { value: 0 },
    uColor:     { value: new THREE.Color(0.04, 0.07, 0.12) },
    uReflect:   { value: 0.7 },
  },
  vertexShader: `
    varying vec2 vUv;
